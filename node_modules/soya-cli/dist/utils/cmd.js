...
const getCommands = () => {
    return [
        ...Object.keys(commands_1.systemCommands),
        'validate',
        'transform',
    ];
};
...
const printTemplateHelp = () => __awaiter(this, void 0, void 0, function* () {
    console.log((0, command_line_usage_1.default)([
        {
            header: 'Description',
...
const printCliHelp = (command) => __awaiter(this, void 0, void 0, function* () {
    if (!command)
        printGeneralHelp();
    else {
        switch (command) {
