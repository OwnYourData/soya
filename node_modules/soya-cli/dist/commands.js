...
const pull = (params, soya) => __awaiter(this, void 0, void 0, function* () {
    ...
    const pullOptions = params.type === 'yaml' ? {
        pullType: 'yaml',
    } : undefined;
    try {
        (0, _1.logNiceConsole)(yield soya.pull(param1, pullOptions));
    }
    catch (e) {
...
const initPush = (_, soya) => __awaiter(this, void 0, void 0, function* () {
    const yamlContent = yield std_1.Std.in();
    if (!yamlContent)
        return (0, core_1.exitWithError)('No YAML content provided via stdin!');
    const contentDocument = yield soya.init(yamlContent);
    try {
        const res = yield soya.push(contentDocument, {
...
const form = (params, soya) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        (0, _1.logNiceConsole)(yield soya.getForm(jsonLd, {
...
const canonical = (_, soya) => __awaiter(this, void 0, void 0, function* () {
    try {
        const input = yield std_1.Std.in();
        if (!input)
            return (0, core_1.exitWithError)('No input JSON-LD specified!');
        const jsonLd = JSON.parse(input);
        (0, _1.logNiceConsole)(yield soya.toCanonical(jsonLd));
    }
    catch (_f) {
        return (0, core_1.exitWithError)('Could not get canonical form!');
    }
});
