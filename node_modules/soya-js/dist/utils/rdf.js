...
exports.factory = exports.isIRI = exports.serializeJsonLd = exports.parseJsonLd = void 0;
...
const serializeJsonLd = (stream, options) => __awaiter(this, void 0, void 0, function* () {
...
const isIRI = (value) => {
    ...
    return value === null || value === void 0 ? void 0 : value.startsWith('http');
};
exports.isIRI = isIRI;
